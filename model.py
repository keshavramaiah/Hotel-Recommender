...
def do():
    ...
    api='4519d076b432f5'
    hotel_details=pd.read_csv('C:\\Users\\SYS TEM\\Desktop\\hotels data\\Hotel_details.csv',delimiter=',')
    hotel_rooms=pd.read_csv('C:\\Users\\SYS TEM\\Desktop\\hotels data\\Hotel_Room_attributes.csv',delimiter=',')
    hotel_cost=pd.read_csv('C:\\Users\\SYS TEM\\Desktop\\hotels data\\hotels_RoomPrice.csv',delimiter=',')
    ...
    optimum_band=pd.read_csv('C:\\Users\\SYS TEM\\Downloads\\hotel_price_min_max - Formula.csv',delimiter=',')
    del hotel['hotelid']
    del hotel['url']
    del hotel['curr']
    del hotel['Source']
